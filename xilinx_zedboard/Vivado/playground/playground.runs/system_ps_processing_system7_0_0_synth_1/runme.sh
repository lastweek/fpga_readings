...
HD_PWD='/home/ys/Github/fpga-related/FPGA/zedboard/Vivado/playground/playground.runs/system_ps_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ps_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ps_processing_system7_0_0.tcl
