...
#
# tri_mode_mac.tcl: Tcl script for re-creating project 'tri_mode_ethernet_mac_0_ex'
#
# Generated by Vivado on Fri Jan 25 12:22:52 EST 2019
...
set script_file "tri_mode_mac.tcl"
...
# Create project
create_project -force ${_xil_proj_name_} "../generated/tri_mode_mac" -part xc7a100tcsg324-1
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../Github/fpga-related/FPGA/xilinx_arty_a7/mac_tri_mode/hls/project_pkt_gen/solution1/impl/ip"] [file normalize "$origin_dir/../../../hls/net_xapp1209/project_net_streaming/solution1/impl/ip"]" $obj
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/../ip/top_func_0_1/top_func_0.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "top_func_0_1/top_func_0.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set orig_proj_dir "[file normalize "$origin_dir/../tri_mode_ethernet_mac_0_ex"]"

# Set 'constrs_1' fileset properties
#set obj [get_filesets constrs_1]
#set_property -name "target_constrs_file" -value "$orig_proj_dir/rtl/tri_mode_ethernet_mac_0_user_phytiming.xdc" -objects $obj
#set_property -name "target_ucf" -value "$orig_proj_dir/rtl/tri_mode_mac/tri_mode_ethernet_mac_0_user_phytiming.xdc" -objects $obj
...
set file [file normalize ${origin_dir}/../rtl/tri_mode_mac/tri_mode_ethernet_mac_0_frame_typ.v]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "used_in" -value "implementation simulation" -objects $file_obj
set_property -name "used_in_synthesis" -value "0" -objects $file_obj

set file [file normalize ${origin_dir}/../rtl/tri_mode_mac/demo_tb.v]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "used_in" -value "implementation simulation" -objects $file_obj
set_property -name "used_in_synthesis" -value "0" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "demo_tb" -objects $obj
