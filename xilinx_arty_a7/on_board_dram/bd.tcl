...
proc create_root_design { parentCell } {
  ...
  # Create instance: top_func_1, and set properties
  set top_func_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:top_func:1.0 top_func_1 ]
  ...
  connect_bd_intf_net -intf_net jtag_axi_1_M_AXI [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins top_func_1/m_axi_axi_a]
connect_bd_intf_net -intf_net [get_bd_intf_nets jtag_axi_1_M_AXI] [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI]
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports ddr3_sdram] [get_bd_intf_pins mig_7series_0/DDR3]
  connect_bd_intf_net -intf_net top_func_1_m_axi_axi_b [get_bd_intf_pins axi_interconnect_0/S02_AXI] [get_bd_intf_pins top_func_1/m_axi_axi_b]
connect_bd_intf_net -intf_net [get_bd_intf_nets top_func_1_m_axi_axi_b] [get_bd_intf_pins axi_interconnect_0/S02_AXI] [get_bd_intf_pins ila_3/SLOT_0_AXI]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins clk_wiz_0/locked] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins ila_1/clk] [get_bd_pins ila_2/clk] [get_bd_pins ila_3/clk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins top_func_1/ap_clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net top_func_1_ap_done [get_bd_pins ila_2/probe0] [get_bd_pins top_func_1/ap_done]
  connect_bd_net -net top_func_1_ap_idle [get_bd_pins ila_2/probe1] [get_bd_pins top_func_1/ap_idle]
  connect_bd_net -net top_func_1_ap_ready [get_bd_pins ila_2/probe2] [get_bd_pins top_func_1/ap_ready]
  connect_bd_net -net top_func_1_flag [get_bd_pins ila_2/probe5] [get_bd_pins top_func_1/flag]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins ila_2/probe3] [get_bd_pins top_func_1/ap_start] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins ila_2/probe4] [get_bd_pins top_func_1/ap_rst_n] [get_bd_pins vio_0/probe_out1]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins ila_2/probe6] [get_bd_pins top_func_1/ptr_a] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins ila_2/probe7] [get_bd_pins top_func_1/ptr_b] [get_bd_pins xlconstant_2/dout]
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0x00000000 [get_bd_addr_spaces top_func_1/Data_m_axi_axi_a] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x10000000 -offset 0x00000000 [get_bd_addr_spaces top_func_1/Data_m_axi_axi_b] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
